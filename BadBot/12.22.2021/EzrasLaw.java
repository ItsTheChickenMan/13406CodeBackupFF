...
/* Note: This sample uses the all-objects Tensor Flow model (FreightFrenzy_BCDM.tflite), which contains
   ...
   */
    ...
    public String[] finalMessages = {"mission accomplished", "payload delivered", "job well done"};
    ...
    public void pivotAngle(double angle, double speed){
        ...
        if(finalOrientation < startingOrientation){
            ...
            while(this.getYRotation() > finalOrientation && !flipped && opModeIsActive()){
                ...
                // check for flip
                if(this.getYRotation() - lastOrientation > 135 || this.getYRotation() - lastOrientation < -135){
                    flipped = true;
                    break;
                }
                
                lastOrientation = this.getYRotation();
