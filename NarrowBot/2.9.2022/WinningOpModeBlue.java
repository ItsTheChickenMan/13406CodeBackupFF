...
public class WinningOpModeBlue extends EzrasLaw {
  ...
  public void runOpMode() {
    ...
    while (opModeIsActive()) {
      ...
      this.telemetry.addData("at target?", !armMotor.isBusy());
      this.telemetry.addData("hub level", this.hubLevel);
      this.telemetry.addData("tune", this.tune);
      this.telemetry.addData("PIDF", this.armMotor.getPIDFCoefficients(DcMotor.RunMode.RUN_TO_POSITION));
      this.telemetry.update();
    } 
  }
}